 ...
 implements dbs.corba.FailureFreeFEOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getLocalAccountCount", new java.lang.Integer (8));
    _methods.put ("setByzantineFlag", new java.lang.Integer (9));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         String accountNum = in.read_string ();
       ...
       {
         String src_accountNum = in.read_string ();
         String dest_accountNum = in.read_string ();
         float amount = in.read_float ();
         boolean $result = false;
  ...
  //result getAccountCount();
       case 8:  // dbs/corba/FailureFreeFE/getLocalAccountCount
       {
         int $result = (int)0;
  ...
  //True if we want to set a replic to artificially produce a wrong result.
       case 9:  // dbs/corba/FailureFreeFE/setByzantineFlag
       {
